...
def main(aws_acces_key_id, aws_secret_access_key, aws_region, role_arn, direct_login=False) :
	...
	logger.info("Starting AutoOff instances")
		...
		for instance in reservation['Instances'] :
			if 'Tags' in instance.keys() :
				...
				if do_start == True :
					...
					logger.info("Instance %s, ID %s started" % (instance_name, instance['InstanceId']))

	logger.info("Finished starting AutoOff instances")
